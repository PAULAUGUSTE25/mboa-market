  ...
  const sectors = [
    {
      ...
      icon: <Sprout className="h-10 w-10 sm:h-12 sm:w-12 text-emerald-400" strokeWidth={1.5} />,
      color: 'emerald',
      items: [
        'Semences',
        'Légumes',
              ...
              >
                ...
                <Link
                  ...
                  style={{
                    ...
                    ...(theme === 'dark' ? getCardStyles(theme, sector.color === 'red' ? 'red' : 'emerald') : {
                      background: '#FFFFFF',
                      border: isSelected 
                        ? `4px solid ${sector.color === 'emerald' ? '#2E7D32' : '#B71C1C'}`
                        : `2px solid ${sector.color === 'emerald' ? '#2E7D32' : '#B71C1C'}`,
                      boxShadow: isSelected 
                        ? `0 25px 70px rgba(${sector.color === 'emerald' ? '16,185,129' : '183,28,28'},0.5), 0 10px 25px rgba(0, 0, 0, 0.3)`
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 md:gap-3 flex-grow">
                    ...
                    <div className="flex justify-center">
                      <div 
                        className={`w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110 ${
                          theme === 'dark' ? `backdrop-blur-sm border ${sector.color === 'emerald' ? 'bg-emerald-500/20 border-emerald-500/30' : 'bg-red-500/20 border-red-500/30'}` : ''
                        }`}
                        style={{
                          background: theme === 'light' ? (sector.color === 'emerald' ? '#2E7D32' : '#B71C1C') : undefined,
                      ...
                      {sector.items.map((item, idx) => (
                        <div
                          ...
                          style={{ 
                            ...
                            border: `2px solid ${sector.color === 'emerald' ? '#2E7D32' : '#B71C1C'}`,
                            color: '#000000',
                    ...
                    <div
                      ...
                      style={{
                        ...(theme === 'dark' ? getButtonStyles(theme, 'primary', sector.color === 'red' ? 'red' : 'emerald') : {
                          background: sector.color === 'emerald' ? '#2E7D32' : '#B71C1C',
                          color: '#FFFFFF',
                          border: 'none',
                          boxShadow: `0 6px 20px rgba(${sector.color === 'emerald' ? '16,185,129' : '183,28,28'},0.4)`
                        })
                      }}
                    >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: index === selectedIndex 
                      ? (sector.color === 'emerald' ? '#2E7D32' : '#B71C1C')
                      : theme === 'light' ? '#D1D5DB' : 'rgba(255, 255, 255, 0.2)',
                    boxShadow: index === selectedIndex 
                      ? `0 0 10px rgba(${sector.color === 'emerald' ? '16,185,129' : '183,28,28'},0.5)`
                      : 'none'
                  }}
                />
              </button>
